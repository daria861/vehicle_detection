...
def run_detection(
    source, model_path, conf, save_results, show_results, color_json, debug):
        ...
        for box in boxes:
            ...
            if label in ["car", "truck", "bus", "motorcycle"]:
                ...
                params = {
                    ...
                    "color": color,
                    "model": make_model,         # Use 'model' key for GUI
                    "plate": license_plate
                }
    ...
    # Return the first car's details (if any), and the car count.
    if vehicle_params:
        first = vehicle_params[0]
        return {
